      ...
      <div class="card w-100">
        <div class="card-header">
            <div class="mb-3 mb-sm-0">
                <h5 class="card-title fw-semibold">Form Edit Layanan</h5>
            </div>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="/layanan/{{ $layanan->id }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nm_layanan" name="nm_layanan" value="{{ $layanan->nm_layanan }}">
                    @error('nm_layanan')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug" value="{{ $layanan->slug }}">
                    @error('slug')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kd_layanan" name="kd_layanan" value="{{ $layanan->kd_layanan }}">
                    @error('kd_layanan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="batas_antrian" name="batas_antrian" value="{{ $layanan->batas_antrian }}">
                    @error('batas_antrian')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="deskripsi" id="deskripsi" rows="10">{{ $layanan->deskripsi }}</textarea>
                    @error('deskripsi')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
